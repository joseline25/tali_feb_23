...
def task_create(request, id):
    ...
    if request.method == "POST":
        ...
        task.name_task = request.POST.get('taskname')
        task.description = request.POST.get('taskdesc')
        task.statut = request.POST.get('TaskStatus')
        task.budget = request.POST.get('taskbudget')
        val = request.POST.get('team')
        #print('val vaut')
        print(val)
        #task.team = request.POST.get('team')
        #print("bonjour")
        task.save()
       
           
    return render(request, 'App/programtasks.html', context)
# edit a task
